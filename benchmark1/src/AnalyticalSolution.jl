...
function spherical_pressure_field(x, x₀, y₀, z₀, r, kF, P0)
    
    C = P0 * 1/(hankelh1(1/2, kF*r) * sqrt(pi/(2*kF*r)))
    
    p = -C * sqrt(pi/(2*kF*distance(x, x₀, y₀, z₀))) * hankelh1(1/2, kF*distance(x, x₀, y₀, z₀))
