...
gmsh.initialize()
gmsh.option.setNumber("Mesh.Algorithm3D", 10) # Number 10 is the HTX algorithm for 3D meshing that is more robust than the frontal one
gmsh.model.add("Rectangle_and_Cube")
