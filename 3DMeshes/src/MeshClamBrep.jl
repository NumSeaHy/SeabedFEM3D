...
cut_operation = gmsh.model.occ.cut([(3, fluid.tag)], [(object[1][1], object[1][2])])

gmsh.model.occ.synchronize()

volume = cut_operation[1]
...
# # Set 3D-physical groups for the resulting fragments fluid_tag = gmsh.model.addPhysicalGroup(3, [volume[1][2]])
fluid_domain = gmsh.model.addPhysicalGroup(3, [volume[1][2]])
